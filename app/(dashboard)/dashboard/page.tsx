...
import { Clock, Wifi, Search, Users, CheckCircle2, FileText, PenTool, X, ImageIcon } from "lucide-react"
...
export default function DashboardPage() {
    ...
    const getStatusUI = (item: any) => {
        let status = "Vắng mặt"
        // Sử dụng opacity cho Dark Mode tương thích
    ...
    return (
        <div className="w-full pb-6 animate-in fade-in duration-500 relative text-foreground">
            ...
            <div className="bg-muted border border-border text-muted-foreground px-5 py-3 rounded-xl mb-6 flex items-center gap-3 font-medium text-[12px] shadow-sm">
                ...
                <span>
                    Hệ thống chấm công yêu cầu kết nối mạng nội bộ. Wifi Bệnh viện Bệnh Nhiệt Đới sử dụng mật khẩu:
            ...
            <div className="hrm-card p-4 flex flex-col md:flex-row gap-4 mb-6">
                ...
                <div className="w-full md:w-64 flex flex-col gap-1.5">
                    ...
                    <select
                        ...
                        className="hrm-input h-10 px-3 rounded-lg border border-border text-[12px] font-medium w-full bg-background text-foreground"
                    >
            ...
            <div className="hrm-card overflow-hidden">
                <div className="px-5 py-4 border-b border-border flex justify-between items-center bg-card">
                    ...
                    <a href="/attendance" className="text-foreground text-[11px] font-bold uppercase tracking-widest hover:underline">
                        Nhật ký đầy đủ &rarr;
                    </a>
                </div>
                ...
                {currentData.length === 0 ? (
                    <div className="p-8 text-center text-muted-foreground font-medium">Chưa có dữ liệu phù hợp.</div>
                ) : (
                    <>
                        {/* --- MOBILE VIEW --- */}
